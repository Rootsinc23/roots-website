...
const About = () => {
  ...
  return (
    <section data-aos="ease-in" className="mx-auto mt-[2rem] px-[1rem]" id="about">
      ...
      <div className="p-7 gap-5 lg:flex lg:items-center lg:justify-center ">
        <div data-aos="fade-up">
          <img src={abt} className="w-[100%] lg:w-[400px] lg:h-[450px]lg:object-cover" alt="about-us" />
        </div>
        <div data-aos="fade-up" className="relative text-left text-[1rem] mt-5 lg:w-1/2">
