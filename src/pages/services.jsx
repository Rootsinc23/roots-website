...
const Services = () => {
  ...
  return ( 
    <section className='mt-[2rem] px-[1rem]'  id='services'>
        ...
        <div className='grid grid-cols-1 grid-rows-2 md:grid-cols-3 w-[100%] p-6 gap-[4rem] mt-[2rem] mb-[1rem]'>
          <div className='text-left' >
            <div className='justify-center items-center flex'>
          <FaPaintBrush size={30} className='m-[5px]' />  
          
          </div>
          <h1 className='text-[2rem] font-bold justify-center items-center flex'>Web Design</h1>
            <br />
          ...
          <h1 className='text-[2rem] font-bold justify-center items-center flex'>Development Expertise</h1>
          <br />
          <h3 className='text-[1rem] font-bold'>Front-end and Back-end Development:</h3>
          <h4>
            Our skilled develpoers implement UI/UX designs using languages like 
          ...
          <FaShoppingCart size={30} className='m-[5px]'/>
            ...
            <h1 className='text-[2rem] font-bold '>Ecommerce development</h1>
            <br />
          ...
          <FaCode size={30} className='m-[5px]'/>
            ...
            <h1 className='text-[2rem] font-bold '>Web Application and Development</h1>
            <br />
            <h3 className='text-[1rem] font-bold'>Dynamic and Interactive solutions:</h3>
            <h4>
              We create dynamic and interactive web applicaitons tailored to specific 
          ...
          <FaUserEdit size={30} className='m-[5px]'/>
            ...
            <h1 className='text-[2rem] font-bold '>Enterprise Development</h1>
            <br />
            <h4>
              ROOTS specializes in crafting enterprise-grade web solutions. Our team
              ensures that your business recieves a tailored, scalable, and secure 
          ...
          <FaTools size={30} className='m-[5px]'/>
            ...
            <h1 className='text-[2rem] font-bold '>Maintenance and Support</h1>
            <br />
            <h3 className='text-[1rem] font-bold'>Ensuring Smooth Functionlity</h3>
            <h4>
              ROOTS provides regular update, bug fixes and ongoing support 
              to ensure your website funtions and stays secure.
            </h4>
